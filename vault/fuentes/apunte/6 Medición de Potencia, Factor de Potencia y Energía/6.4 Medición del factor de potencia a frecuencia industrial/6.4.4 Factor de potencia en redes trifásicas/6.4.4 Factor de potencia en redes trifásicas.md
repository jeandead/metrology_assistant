# 6.4.4 Factor de potencia en redes trifásicas

Tags: #eli214
## 6.4.4. Factor de potencia en redes trifásicas

En sistemas trifásicos se puede medir el factor de potencia con un instrumento de bobinas cruzadas, solo que en este caso será posible obtener el desfase necesario desde las bobinas móviles empleando las tensiones de línea, eliminando la reactancia X L .

En sistemas trifásicos desequilibrados, el factor de potencia carece de sentido y generalmente se calcula como la razón entre la potencia activa y aparente trifásicas. En algunos casos es opcional indicar el factor de potencia de cada una de las fases.
