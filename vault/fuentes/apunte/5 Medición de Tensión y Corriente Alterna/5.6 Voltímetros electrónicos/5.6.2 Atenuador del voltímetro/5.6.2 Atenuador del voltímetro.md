# 5.6.2 Atenuador del voltímetro

Tags: #eli214
## 5.6.2. Atenuador del voltímetro

El atenuador o adaptador es en principio muy similar al descrito en instrumentos de continua , también visto en los esquemas anteriores de instrumentos electrónicos y que a su vez las conclusiones aquí obtenidas son rápidamente extrapolables a amperímetros de corriente alterna.

Sin embargo se debe hacer detalle en que el atenuador debe tener una etapa de compensación para obtener el ancho de banda requerido. Si típicamente la resistencia de entrada R s de un voltímetro electrónico son 10MΩ en paralelo se conecta un condensador de 20 a 50pF , es decir, la impedancia de entrada es ahora dependiente de la frecuencia.


![Diagrama](../../../_figures/image_228.png)



![Diagrama](../../../_figures/image_229.png)


Según la configuración usada, se usa también en algunos casos un condensador de entrada serie, para eliminar la componente continua, formando una configuración 'pasa-altos' con frecuencia de corte inferior entre 5 a 10Hz .
