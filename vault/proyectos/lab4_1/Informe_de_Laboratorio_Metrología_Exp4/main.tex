...
\begin{titlepage}
    ...
    \vspace{0.5cm}
    \Huge \textbf{Experiencia N° 4}
    
    \vspace{0.3cm}
    \large  “Osciloscopio Digital Parte 1”
...
\input{sections/1resumen}

\newpage
\section{Introducción}
\input{sections/2introduccion}

\newpage
\section{Marco Teórico}
\input{sections/3marco_teorico}


\newpage
\section{Desarrollo de la Experiencia}
\input{sections/4experiencia}

\section{Resultados}
\input{sections/5datos}
